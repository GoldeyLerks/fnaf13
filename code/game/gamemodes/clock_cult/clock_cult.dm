...
/proc/is_eligible_servant(mob/M)
	if(!istype(M))
		return FALSE
	if(M.mind)
		if(ishuman(M) && (M.mind.assigned_role in list("Manager", "Chaplain")))
			return FALSE
...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Manager") //Silicons can eventually be converted
	restricted_jobs = list("Chaplain", "Manager")
	announce_span = "brass"
