...
GLOBAL_LIST_INIT(sandstone_recipes, list ( \
	...
	new/datum/stack_recipe("Child Statue", /obj/structure/statue/sandstone/assistant, 5, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(diamond_recipes, list ( \
	...
	new/datum/stack_recipe("Manager Statue", /obj/structure/statue/diamond/captain, 5, one_per_turf = 1, on_floor = 1), \
