...
/obj/item/station_charter
	...
	desc = "An official document entrusting the governance of the station \
		and surrounding space to the Manager."
	var/used = FALSE
...
/obj/item/station_charter/proc/rename_station(designation, uname, ureal_name, ukey)
	...
	minor_announce("[ureal_name] has designated your station as [station_name()]", "Manager's Charter", 0)
	log_game("[ukey] has renamed the station as [station_name()].")

	name = "station charter for [station_name()]"
	desc = "An official document entrusting the governance of \
		[station_name()] and surrounding space to Manager [uname]."
...
/obj/item/station_charter/flag/rename_station(designation, uname, ureal_name, ukey)
	set_station_name(designation)
	minor_announce("[ureal_name] has designated the planet as [station_name()]", "Manager's Banner", 0)
	log_game("[ukey] has renamed the planet as [station_name()].")
	name = "banner of [station_name()]"
	desc = "The banner bears the official coat of arms of Nanotrasen, signifying that [station_name()] has been claimed by Manager [uname] in the name of the company."
	SSblackbox.record_feedback("text", "station_renames", 1, "[station_name()]")
	if(!unlimited_uses)
		used = TRUE
