...
/obj/item/pda
	...
	var/note = "Congratulations, your station has chosen the Thinktronic 5230 Personal Data Child!" //Current note in the notepad function
	var/notehtml = ""
