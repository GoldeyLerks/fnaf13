...
GLOBAL_LIST_INIT(fnaf_animatronic_names, world.file2list("strings/names/animatronics.txt"))
...
GLOBAL_LIST_INIT(preferences_custom_names, list(
	...
	*/
	"animatronic" = list("pref_name" = "Animatronic", "qdesc" = "animatronic name", "group" = "silicons", "allow_numbers" = TRUE)
	))
