...
#define COMSIG_GLOB_NEW_STATION_NAME "!station_name"			//called when the station name is set by the name of an animatronic, from /datum/antagonist/animatronic/on_gain (animatronic_name)
...
#define COMSIG_MOVABLE_PULL "movable_pull"						//from base of mob/living/start_pulling(): (mob/living)
