...
/obj/docking_port/mobile/emergency/request(obj/docking_port/stationary/S, area/signalOrigin, reason, redAlert, set_coefficient=null)
	...
	//priority_announce("Your parents have been called. [redAlert ? "They're driving really fast. " : "" ]They will arrive in [timeLeft(600)] minutes.[reason][SSshuttle.emergencyLastCallLoc ? "\n\nCall signal traced. Results can be viewed on any communications console." : "" ]", null, 'sound/ai/shuttlecalled.ogg', "Priority")
...
/obj/docking_port/mobile/emergency/cancel(area/signalOrigin)
	...
	if(prob(70))
		...
		SSshuttle.emergencyLastCallLoc = null
	priority_announce("Your moms are going home.", null, 'sound/ai/shuttlerecalled.ogg', "Priority")
	...
	switch(mode)
		...
		if(SHUTTLE_CALL)
			if(time_left <= 0)
				...
				priority_announce("Your moms SUV have arrived. You have [timeLeft(600)] minutes to get home.", null, 'sound/ai/shuttledock.ogg', "Priority")
				ShuttleDBStuff()
