...
/datum/uplink_item/stealthy_tools/fakenucleardisk
	...
	desc = "It's just a normal disk. Visually it's identical to the real deal, but it won't hold up under closer scrutiny by the Manager. Don't try to give this to us to complete your objective, we know better!"
...
/datum/uplink_item/badass/costumes/centcom_official
	...
	desc = "Ask the crew to \"inspect\" their nuclear disk and weapons system, and then when they decline, pull out a fully automatic rifle and gun down the Manager. Radio headset does not include key. No gun included."
